...
@Component({
    ...
    imports: [MatCardModule, MatButtonModule, MatMenuModule, MatTabsModule, TAllComponent, TInProgressComponent, TFinishedComponent, TPassedComponent, TFailedComponent],
